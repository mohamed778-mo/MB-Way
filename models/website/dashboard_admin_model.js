...
var DashAdminSchema = new mongoose.Schema({
        name:{
            type:String,
        },
        email:{
...
DashAdminSchema.pre("save",async function(){
...
DashAdminSchema.methods.toJSON = function(){
    const user = this
...
module.exports = mongoose.model('Dashadmin', DashAdminSchema);